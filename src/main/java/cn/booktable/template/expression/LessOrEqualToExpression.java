...
public class LessOrEqualToExpression implements BinaryOperationExpression{
	...
	public boolean comparison(Object left, Object right) {
		return executeLessOrEquals(left,right);
	}
	


	public boolean executeLessOrEquals(Object left,Object right)
	{
		if(left==null ){
			if(right==null){
				return true;
