...
public class GreaterExpression implements BinaryOperationExpression{
	...
	public boolean comparison(Object left, Object right) {
		return executeGreater(left,right);
	}
	

	public boolean executeGreater(Object left,Object right)
	{
