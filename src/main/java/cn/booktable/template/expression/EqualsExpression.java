...
public class EqualsExpression implements BinaryOperationExpression{
	...
	public boolean comparison(Object left, Object right) {
		...
		return executeEquals(left,right);
	}




	public boolean executeEquals(Object left,Object right)
	{
		if(left==null ){
			if(right==null){
				return true;
